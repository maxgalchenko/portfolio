    ...
    element: (
      <PageTransition>
        <Company
          ...
          companyDescription="I led the design and implementation of web applications and microfrontends, emphasizing software quality through Test-Driven Development (TDD). Additionally, I focused on creating comprehensive documentation for software processes and collaborated closely with cross-functional teams to integrate systems seamlessly. Alongside this, I spearheaded the frontend department, providing leadership and direction. Notably, I made significant contributions to Conexiom, a pioneering solution automating manual data entry for top global companies. My involvement played a key role in transforming their sales order processing from manual to automated systems. This experience highlights my ability to merge technical innovation with impactful solutions."
        />
      </PageTransition>
    ),
  },
