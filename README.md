...
![React](https://img.shields.io/badge/React-61DAFB?style=for-the-badge&logo=react&logoColor=black) ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=for-the-badge&logo=typescript&logoColor=white) ![Create React App](https://img.shields.io/badge/Create%20React%20App-09D3AC?style=for-the-badge&logo=create-react-app&logoColor=white) ![Emotion](https://img.shields.io/badge/Emotion-D36AC2?style=for-the-badge&logo=emotion&logoColor=white) ![React Router](https://img.shields.io/badge/React%20Router-CA4245?style=for-the-badge&logo=react-router&logoColor=white)
...
React 18, TypeScript 4.9, Create React App, Emotion CSS-in-JS, React Router v6, React Spring

## Architecture

Built with Create React App and React Router v6 for client-side routing. Uses Emotion for CSS-in-JS styling with a centralized theme system. Custom hooks for breakpoint detection enable responsive behavior. Page transitions implemented with React Spring animations. Component structure organized by pages and common reusable components.
